...
import { getWalletHistoric } from '@/services/historicService.ts' // Ajuste o caminho conforme necessário
...
describe('getWalletHistoric', () => {
  ...
  it('should handle error when fetching wallet historic', async () => {
