                ...
                <div className="h-3/5 w-3/5">
                    ...
                    <div className="w-full h-2/5">
                        <div className="w-full h-1/2 flex flex-col justify-center items-start gap-2.5">
                            ...
                            <Input type="email" id="email" placeholder="Email" className="bg-gray-800 text-gray-400 border-transparent h-12"/>
                        </div>
                        <div className="w-full h-1/2 flex flex-col justify-center items-start gap-2.5">
                            <Label htmlFor="password" className="text-white text-lg">Password</Label>
                            <Input type="password" id="password" placeholder="Password" className="bg-gray-800 text-gray-400 border-transparent h-12"/>
                        </div>
                    </div>
                    <div className="w-full h-1/4">
                        <div className="w-full h-1/2 flex justify-end items-center text-lg text-blue-600">
                            <a href="" className="hover:opacity-70 cursor-pointer">Forgot password?</a>
                        </div>
                        <div className="w-full h-1/2 flex justify-center items-center">
                            <Button className="bg-yellow-500 text-black w-full h-5/6 text-xl hover:bg-yellow-500/70">Sign in</Button>
                        </div>
                    </div>
                </div>
            </div>
