    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="h-1/3 w-[200%] bg-[#131313] text-[#fff] m-0">
        ...
        <div className="flex flex-row">
          ...
          <div className="h-full w-1/2 flex justify-start items-center text-[#959CB6]">{name}</div>
        </div>
        <div className="flex flex-row">
          <div className="h-full w-1/2 flex justify-start items-center">Email</div>
          <div className="h-full w-1/2 flex justify-start items-center text-[#959CB6]">{email}</div>
        </div>
        <div className="flex flex-row">
          <div className="h-full w-1/2 flex justify-start items-center">Phone</div>
          <div className="h-full w-1/2 flex justify-start items-center text-[#959CB6]">{phone}</div>
        </div>
      </DialogContent>
    </Dialog>
  )
