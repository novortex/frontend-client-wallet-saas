...
export default function CardCloseWallet({
  ...
  return (
    <Card className="w-[32%] border-[#323232] bg-[#1c1c1c]">
      <CardHeader>
      ...
      <CardFooter className="flex flex-col items-start gap-4">
        <div
          className={`w-[90%] ${tagBgColor1} rounded-2xl p-1 text-start text-[#fff]`}
        >
          <p className="ml-2">
        ...
        {tagColor2 && value2 !== undefined && (
          <div
            className={`w-[95%] ${tagBgColor2} rounded-2xl p-1 text-start text-[#fff]`}
          >
