...
export function AddNewWalletModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="h-[45%] w-[200%] border-transparent dark:bg-[#131313] dark:text-[#fff]">
        <DialogHeader>
        ...
        <div className="flex w-full flex-col gap-4">
          <div className="flex h-1/2 w-full flex-row items-start justify-between gap-4">
            <div className="flex w-1/2 flex-col gap-3">
              <Select onValueChange={(item) => setSelectedAsset(item)}>
                <SelectTrigger className="h-full w-full bg-lightComponent dark:border-[#323232] dark:bg-[#131313]">
                  <SelectValue placeholder="Asset" />
                </SelectTrigger>
                <SelectContent className="dark:border-2 dark:border-[#323232] dark:bg-[#131313]">
                  {assetForSelected &&
            ...
            <div className="flex w-1/2 flex-col gap-3">
              <Input
                type="number"
                className="h-full w-full bg-lightComponent dark:border-[#323232] dark:bg-[#131313] dark:text-[#959CB6]"
