        ...
        <CardTitle className="flex flex-row">
          ...
          <div className="relative h-full w-1/2 flex items-center justify-end">
            <div className="relative group">
              ...
              <div className="absolute top-full right-full mb-2 w-[700%] px-4 py-2 bg-black text-sm text-white text-start rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                {name}
                <br />
                email: {email}
                <br />
