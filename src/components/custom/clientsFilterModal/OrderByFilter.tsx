...
const filterOptions: {
  name: keyof FilterProps['filters']
  label: string
}[] = [
  { name: 'newest', label: 'Newest' },
  { name: 'older', label: 'Older' },
  {
    name: 'nearestRebalancing',
    label: 'Nearest rebalancing',
  },
  {
    name: 'furtherRebalancing',
    label: 'Further rebalancing',
  },
]
...
export function OrderByFilter({
  ...
  const handleCheckboxChange = (
    ...
    for (const [key, value] of Object.entries(
      ...
      onFilterChange(
        key as keyof FilterProps['filters'],
        value as boolean
      )
    }
  }
