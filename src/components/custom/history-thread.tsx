    ...
    switch (operationType) {
      ...
      case 'WITHDRAWAL':
        return (
          <div className="flex flex-row gap-1.5">
            <p className="font-bold">{user}</p>{' '}
            performed a withdrawal on {date} (
            {hour})
          </div>
        )
      case 'START_WALLET':
